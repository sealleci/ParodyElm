  ...
  <div style="height: 100%;width: 100%">
    <van-row style="position: relative;top: 1vh;left: 2vw;">
      <van-image :src="crossImage" height="32" width="32"
                 @click="toLogin" style="cursor: pointer;"/>
    </van-row>
    ...
    <van-row style="margin:0 0 4vh;"
      ...
      <van-field v-model="newPhone" type="tel" label="手机号" placeholder="手机号"
                 :formatter="formatter"/>
      <van-field v-model="newPwd" type="password" label="密码" placeholder="密码"
                 :right-icon="isCloseEye" class="my-pwd-input"
                 v-show="isCloseEyeBool"/>
      <van-field v-model="newPwd" type="text" label="密码" placeholder="密码"
                 :right-icon="isCloseEye" class="my-pwd-input"
                 v-show="!isCloseEyeBool"/>
    </van-row>
...
export default {
  ...
  data () {
    return {
      ...
      myPhone: '1594890315',
      showInPwd: false,
      closeEye: require('../../src/assets/images/aliuser_ic_visibility_off.png'),
      openEye: require('../../src/assets/images/aliuser_ic_visibility.png'),
