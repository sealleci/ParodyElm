<template>
  <div style="height: 100%">
    <van-row style="position: relative;top: 1vh;left: 2vw;">
      <van-image :src="crossImage" height="32" width="32"
                 @click="toProfile" style="cursor: pointer;"/>
    </van-row>
    <van-row type="flex" justify="center" style="margin:5vh 0;">
      <van-image :src="eleImage" round height="60"
                 :style="`background-color: ${elemeColor};`"/>
    </van-row>
    <van-row type="flex" justify="center" style="font-size:12px;color: gray;margin:3vh 0 1vh;">使用本机号码一键登录
    </van-row>
    <van-row style="margin:0 0 4vh;"
             type="flex" justify="center">
      <div style="font-size: 30px;">{{ calcNumber }}</div>
    </van-row>
    <van-row type="flex" align="center"
             style="flex-direction: column;">
      <van-button round type="primary" style="width: 90%;margin-bottom: 1vh;"
                  @click="mobileLogin">登录
      </van-button>
      <van-button round style="width: 90%;"
      @click="toPassword">使用其他手机登录</van-button>
    </van-row>
...
export default {
  ...
  data () {
    return {
      crossImage: require('../../src/assets/images/ali_ucc_dialog_close.png'),
      eleImage: require('../../src/assets/images/od_icon_take_meal_ele_logo.png'),
      elemeColor: '#02b6fd',
      myPhone: '1594890315',
      loginIcons: [
        require('../../src/assets/images/ic_account_alipay.png'),
        require('../../src/assets/images/wml_open_wopc_auth_taobao.png'),
        require('../../src/assets/images/ic_account_wechat.png'),
        require('../../src/assets/images/wml_miniapp_bar_more_dark.png')
      ],
